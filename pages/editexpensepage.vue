    ...
    <ion-content class="custom-background">
      <ion-card>
        ...
        <div class="add-container">
          <button class="add-button" @click="updateExpense">
            <h1><b>UPDATE</b></h1>
          </button>
        </div>
...
const expenseId = ref(route.query.id); //ID from the query string 
...
async function fetchExpense() {
  ...
  recurringSchedule.value = data.recurringSchedule;
}
